...
namespace PrefectVotingApplication.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(PrefectVotingApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var prefectVotingApplicationDbContext = _context.User.Include(u => u.Role);
        ...
        public async Task<IActionResult> Create([Bind("UserId,FirstName,LastName,Email,ImagePath,Description,RoleId")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,FirstName,LastName,Email,ImagePath,Description,RoleId")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
